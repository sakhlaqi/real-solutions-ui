...
import { DateTimePicker } from '../../src/adapters/DateTimePicker';
...
export const WithSeconds: Story = {
  args: {
    ...
    value: new Date('2024-06-15T14:30:45'),
    showSeconds: true,
  },
};
...
export const AppointmentBooking: Story = {
  render: () => {
    ...
    const handleBook = () => {
      if (appointmentTime) {
        setIsBooked(true);
        // Note: setTimeout removed for deterministic visual testing
      }
    };
    ...
    return (
      <div style={{ minWidth: '400px' }}>
        ...
        <DateTimePicker
          ...
          minDate={new Date('2024-06-15T09:00:00')}
        />
