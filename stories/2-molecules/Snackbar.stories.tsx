...
import { Snackbar } from '../../src/adapters/Snackbar';
...
export const MultipleNotifications: Story = {
  render: () => {
    ...
    const addNotification = (message: string, severity: string) => {
      ...
      // Note: Auto-dismiss removed for deterministic visual testing
      // Visual regression tests should capture stable state
    };
