...
/**
 * Header with complete business data.
 */
export const WithData: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates a fully populated header with realistic business data including navigation, actions, and metadata.',
      },
    },
  },
  args: {
    title: 'Customer Analytics Dashboard',
    subtitle: 'Real-time insights and metrics for Q1 2024 performance',
    breadcrumbs: [
      { label: 'Analytics', href: '#/analytics' },
      { label: 'Customers', href: '#/analytics/customers' },
      { label: 'Dashboard', href: '#/analytics/customers/dashboard' },
    ],
    showBackButton: true,
    actions: [
      { 
...
export const Loading: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Shows header during data loading with disabled actions.',
      },
    },
  },
  args: {
...
export const Empty: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Minimal header with just a title, suitable for empty states or simple pages.',
      },
    },
  },
  args: {
    title: 'No Data Available',
    subtitle: 'Start by creating your first record',
  },
};

/**
 * Header displaying error state.
 */
export const Error: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Header showing error state with retry action.',
      },
    },
  },
  args: {
    title: 'Error Loading Data',
    subtitle: 'Unable to fetch the requested information. Please try again.',
    breadcrumbs: [
      { label: 'Home', href: '#/' },
      { label: 'Error', href: '#' },
    ],
...
export const AdapterFallback: Story = {
  parameters: {
    docs: {
      description: {
        story: `
This story tests how HeaderComposite handles provider switching.

**Testing Instructions:**
1. Use the **UI Provider** toolbar control to switch between providers
2. Verify the header renders consistently across providers
3. Check that breadcrumbs, title, subtitle, and actions all display correctly
4. Ensure back button and action buttons function properly

**Expected Behavior:**
- MUI provider: Uses Material-UI components with theme integration
- Internal provider: Falls back to MUI implementation (or custom if configured)
- All functionality should work regardless of provider selection
        `,
      },
    },
  },
  args: {
    title: 'Provider Test Page',
    subtitle: 'Switch providers using the toolbar to see adapter behavior',
    breadcrumbs: [
      { label: 'Testing', href: '#/testing' },
      { label: 'Adapters', href: '#/testing/adapters' },
      { label: 'HeaderComposite', href: '#/testing/adapters/header' },
    ],
    showBackButton: true,
    actions: [
      { 
        ...
        label: 'Test Action', 
        variant: 'primary',
        onClick: () => alert('Action clicked - check which provider is active!')
      },
      { 
        id: 'test-secondary', 
