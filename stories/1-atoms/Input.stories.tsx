...
/**
 * Loading state (read-only while data loads)
 */
export const Loading: Story = {
  args: {
    ...
    value: 'Loading...',
    disabled: true,
    helperText: 'Fetching your email address',
  },
};

/**
 * Empty state with placeholder guidance
 */
 ...
 * Internal provider falls back to MUI implementation
 */
export const AdapterFallback: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Tests adapter resolution. Switch between MUI and Internal providers using the toolbar to see fallback behavior.',
      },
    },
  },
  args: {
    label: 'Test Adapter',
    placeholder: 'Testing provider fallback',
    helperText: 'Switch providers in toolbar above',
  },
};
